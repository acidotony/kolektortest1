...
public class StageBoletaPSRMDTO {
    ...
    private List<StagePagoPSRMDTO> listPagos;

    public StageBoletaPSRMDTO() {
        listPagos = new ArrayList<StagePagoPSRMDTO>();
    }

    public List<StagePagoPSRMDTO> getListPagos() {
        return listPagos;
    }

    public void setListPagos(List<StagePagoPSRMDTO> listPagos) {
    ...
    public void setIdRecaudador(String ente) {
        this.idRecaudador = ente;
    }
    ...
    public String toString() {
        return "StageBoletaPSRMDTO{" +
                ", idEventoPago='" + idEventoPago + '\'' +
                ", idBoleta='" + idBoleta + '\'' +
                ", idPersona='" + idPersona + '\'' +
                ...
                ", moneda='" + moneda + '\'' +
                ", fechaPago=" + fechaPago +
                ", idCuentaContribuyente='" + idCuentaContribuyente + '\'' +
